...
@plugin "daisyui/theme" {
  ...
  prefersdark: true;
  color-scheme: dark;
  --color-primary: oklch(0.7 0.2 55);
...
```html
<html data-signals-theme="'sneak'" data-signals-search="''" data-signals-page="1" data-signals-show_deleted="false" data-signals-current_file="''"></html>
```

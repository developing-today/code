...
setup=function ()
vim.api.nvim_create_user_command(cmd,[[lua require"packer.load"({"vim-fugitive"},{},_G.packer_plugins)
...
config=function ()
vim.cmd[[if g:loaded_remote_plugins=="not loaded"
...
vim.api.nvim_create_user_command('Tutor',[[delcommand Tutor
